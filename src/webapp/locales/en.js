export default {
  ...
  bee_detector: {
    ...
    via_flying: 'Detect Flying Bee',
    via_box: 'Detect Walking Bee',
    ...
    upload: 'Upload video',
    max_fps : 'Frames per second(fps)',
    min_move_distance : 'Minimum Move Distance (cm)',
    max_move_distance : 'Maximum Move Distance (cm)',
